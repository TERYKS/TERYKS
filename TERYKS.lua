...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TERYKS/Files_TERYKS/master/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/TERYKS/TERYKS/master/TERYKS.lua')
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TERYKS/Files_TERYKS/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/TERYKS/Files_TERYKS/master/File_Bot/"..file)
if res == 200 then
